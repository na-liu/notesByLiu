1. https://www.cnblogs.com/xym4869/p/11282586.html
...
6. 图片：![图片注释文字](C:\Users\娜\Pictures\Camera Roll\1.png)
...
10. 单行代码：一对反引号  代码块：三对反引号

11. <font face="黑体">我是黑体字</font>
...
[source](https://www.jianshu.com/p/e74eb43960a1 )

1. 数学公式的记录  以$$包围，也可以用双dollar包围。
  - $$x+y_1^2$$
  - 上标用^，下标用_
  - 汉字形式，符号：`\mbox{}`，如：$V_{\mbox{初始}}$   $V_{初始}$
